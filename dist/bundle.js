...
_reactDom2.default.render(_react2.default.createElement(_App2.default, null), document.getElementById('app')); // import 'babel-polyfill';
...
var App = function (_Component) {
	...
	_createClass(App, [{
		...
		value: function getAverage() {
			var num1 = parseInt(this.input1.value, 10);
			var num2 = parseInt(this.input2.value, 10);

			this.setState({
				result: (0, _average.average)([num1, num2])
			});
		}
	}, {
		key: 'render',
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement('input', { ref: function ref(_ref) {
						if (_ref) _this2.input1 = _ref;
					}, type: 'text' }),
				_react2.default.createElement('input', { ref: function ref(_ref2) {
						if (_ref2) _this2.input2 = _ref2;
					}, type: 'text' }),
				_react2.default.createElement(
					'button',
					{ type: 'button', onClick: this.getAverage },
					'Get Average'
				),
				result !== 0 && _react2.default.createElement(
					'h2',
					null,
					result
				)
